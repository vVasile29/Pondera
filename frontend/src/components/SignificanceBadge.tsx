    ...
    return (
      <Card>
        <CardContent className="p-4 text-sm text-muted-foreground">
          Not enough data for statistical significance analysis (need at least 2
    ...
    <Card>
      <CardContent className="p-4 space-y-2">
        ...
        <p className={`text-sm ${colorClass}`}>
          {significance.winner_name} ({significance.winner_avg}%) vs{" "}
          {significance.runner_name} ({significance.runner_avg}%)
        </p>
